            ...
            this.setButtonHtml(`
                <div class="content-widget-row">
                    <div class="widget-thumb widget-thumb-kids">
                        <img src="{{ url('assets/template/themes/kids/images/widget-1.png') }}"/>
                    </div>
                    <div class="desc">
                        <label>Header</label>
                    </div>
                                                                           ...
                                                                           <tbody><tr style="vertical-align: top;" valign="top">
                                                                              <td style="word-break: break-word; vertical-align: top; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px;" valign="top">
                                                                                 <table align="left" cellpadding="0" cellspacing="0" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" valign="top">
                                                                                    <tbody><tr style="vertical-align: top;" valign="top">
                                                                                       <td align="center" style="word-break: break-word; vertical-align: top; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 5px;" valign="top"><img builder-element="" align="center" alt="" class="icon" height="32" src="{{ url('assets/template/themes/kids/images/Logo_1.png') }}" style="border:0;" width="null"></td>
                                                                                    </tr>
                                                                                 </tbody></table>
                                                                              </td>
                                                                           </tr>
    ...
    class KidsIntroWidget extends Widget {
        ...
        init() {
            ...
            this.setButtonHtml(`
                <div class="content-widget-row">
                    <div class="widget-thumb widget-thumb-kids">
                        <img src="{{ url('assets/template/themes/kids/images/widget-2.png') }}"/>
                    </div>
                    <div class="desc">
                        <label>Intro</label>
                    </div>
                                                                           ...
                                                                           <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                              <tr style="line-height:0px">
                                                                                 <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                                    <![endif]--><img builder-element="" align="center" alt="Happy Kids Looking" border="0" class="center fixedwidth fullwidthOnMobile" src="{{ url('assets/template/themes/kids/images/happy_kids.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 646px; max-width: 100%; display: block;" title="Happy Kids Looking" width="646">
                                                                                    <!--[if mso]>
                                                                                 </td>
                                                                              </tr>
                                                                           </table>
    ...
    class KidsWaveWidget extends Widget {
        ...
        init() {
            ...
            this.setButtonHtml(`
                <div class="content-widget-row">
                    <div class="widget-thumb widget-thumb-kids">
                        <img src="{{ url('assets/template/themes/kids/images/widget-3.png') }}"/>
                    </div>
                    <div class="desc">
                        <label>Divider</label>
                    </div>
    ...
    class KidsImageLeftWidget extends Widget {
        ...
        init() {
            ...
            this.setButtonHtml(`
                <div class="content-widget-row">
                    <div class="widget-thumb widget-thumb-kids">
                        <img src="{{ url('assets/template/themes/kids/images/widget-4.png') }}"/>
                    </div>
                    <div class="desc">
                                                                     ...
                                                                     <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                                                        ...
                                                                        <div align="center" class="img-container center fixedwidth fullwidthOnMobile big" style="padding-right: 0px;padding-left: 0px;">
                                                                           ...
                                                                           <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                              <tr style="line-height:0px">
                                                                                 <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                                    <![endif]--><img builder-element="" align="center" alt="Kid eating" border="0" class="center fixedwidth fullwidthOnMobile" src="{{ url('assets/template/themes/kids/images/Starving_child.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 340px; max-width: 100%; display: block;" title="Kid eating" width="340">
                                                                                    <!--[if mso]>
                                                                                 </td>
                                                                              </tr>
                                                                           </table>
    ...
    class KidsStatsWidget extends Widget {
        ...
        init() {
            ...
            this.setButtonHtml(`
                <div class="content-widget-row">
                    <div class="widget-thumb widget-thumb-kids">
                        <img src="{{ url('assets/template/themes/kids/images/widget-5.png') }}"/>
                    </div>
                    <div class="desc">
                        <label>Stats</label>
                    </div>
    ...
    class KidsImageRightWidget extends Widget {
        ...
        init() {
            ...
            this.setButtonHtml(`
                <div class="content-widget-row">
                    <div class="widget-thumb widget-thumb-kids">
                        <img src="{{ url('assets/template/themes/kids/images/widget-6.png') }}"/>
                    </div>
                    <div class="desc">
                                                                     ...
                                                                     <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                                                        ...
                                                                        <div align="center" class="img-container center fixedwidth fullwidthOnMobile big" style="padding-right: 0px;padding-left: 0px;">
                                                                           ...
                                                                           <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                              <tr style="line-height:0px">
                                                                                 <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                                    <![endif]--><img builder-element="" align="center" alt="Kids in Hospital" border="0" class="center fixedwidth fullwidthOnMobile" src="{{ url('assets/template/themes/kids/images/kids_hospital.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 340px; max-width: 100%; display: block;" title="Kids in Hospital" width="340">
                                                                                    <!--[if mso]>
                                                                                 </td>
                                                                              </tr>
                                                                           </table>
    ...
    class KidsGalleryWidget extends Widget {
        ...
        init() {
            ...
            this.setButtonHtml(`
                <div class="content-widget-row">
                    <div class="widget-thumb widget-thumb-kids">
                        <img src="{{ url('assets/template/themes/kids/images/widget-7.png') }}"/>
                    </div>
                    <div class="desc">
                        <label>Gallery</label>
                    </div>
                                                                     ...
                                                                     <div style="border-top:10px solid #FDF1DA; border-left:10px solid #FDF1DA; border-bottom:10px solid #FDF1DA; border-right:10px solid #FDF1DA; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                                                        ...
                                                                        <div align="center" class="img-container center fixedwidth fullwidthOnMobile big" style="padding-right: 0px;padding-left: 0px;">
                                                                           ...
                                                                           <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                              <tr style="line-height:0px">
                                                                                 <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                                    <![endif]--><img builder-element="" align="center" alt="Kids showing Peace sign" border="0" class="center fixedwidth fullwidthOnMobile" src="{{ url('assets/template/themes/kids/images/donation_2_2.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 320px; max-width: 100%; display: block;" title="Kids showing Peace sign" width="320">
                                                                                    <!--[if mso]>
                                                                                 </td>
                                                                              </tr>
                                                                           </table>
                                                                        ...
                                                                        <div align="center" class="img-container center fullwidthOnMobile fixedwidth big" style="padding-right: 0px;padding-left: 0px;">
                                                                           ...
                                                                           <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                              <tr style="line-height:0px">
                                                                                 <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                                    <![endif]--><img builder-element="" align="center" alt="Boy running with guitar" border="0" class="center fullwidthOnMobile fixedwidth" src="{{ url('assets/template/themes/kids/images/donation_1_1.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 320px; max-width: 100%; display: block;" title="Boy running with guitar" width="320">
                                                                                    <!--[if mso]>
                                                                                 </td>
                                                                              </tr>
                                                                           </table>
                                                                     ...
                                                                     <div style="border-top:10px solid #FDF1DA; border-left:10px solid #FDF1DA; border-bottom:10px solid #FDF1DA; border-right:10px solid #FDF1DA; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                                                        ...
                                                                        <div align="center" class="img-container center fixedwidth fullwidthOnMobile big" style="padding-right: 0px;padding-left: 0px;">
                                                                           ...
                                                                           <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                              <tr style="line-height:0px">
                                                                                 <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                                    <![endif]--><img builder-element="" align="center" alt="Food Donation" border="0" class="center fixedwidth fullwidthOnMobile" src="{{ url('assets/template/themes/kids/images/Donation_3_1.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 320px; max-width: 100%; display: block;" title="Food Donation" width="320">
                                                                                    <!--[if mso]>
                                                                                 </td>
                                                                              </tr>
                                                                           </table>
                                                                        ...
                                                                        <div align="center" class="img-container center fixedwidth fullwidthOnMobile big" style="padding-right: 0px;padding-left: 0px;">
                                                                           ...
                                                                           <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                                              <tr style="line-height:0px">
                                                                                 <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                                                                    <![endif]--><img builder-element="" align="center" alt="Child looking at camera" border="0" class="center fixedwidth fullwidthOnMobile" src="{{ url('assets/template/themes/kids/images/Donation_4_1.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 320px; max-width: 100%; display: block;" title="Child looking at camera" width="320">
                                                                                    <!--[if mso]>
                                                                                 </td>
                                                                              </tr>
                                                                           </table>
    ...
    class KidsDonateWidget extends Widget {
        ...
        init() {
            ...
            this.setButtonHtml(`
                <div class="content-widget-row">
                    <div class="widget-thumb widget-thumb-kids">
                        <img src="{{ url('assets/template/themes/kids/images/widget-8.png') }}"/>
                    </div>
                    <div class="desc">
                        <label>Donate</label>
                    </div>
    ...
    class KidsPlansWidget extends Widget {
        ...
        init() {
            ...
            this.setButtonHtml(`
                <div class="content-widget-row">
                    <div class="widget-thumb widget-thumb-kids">
                        <img src="{{ url('assets/template/themes/kids/images/widget-9.png') }}"/>
                    </div>
                    <div class="desc">
                        <label>Plans</label>
                    </div>
    ...
    class KidsFooterWidget extends Widget {
        ...
        init() {
            ...
            this.setButtonHtml(`
                <div class="content-widget-row">
                    <div class="widget-thumb widget-thumb-kids">
                        <img src="{{ url('assets/template/themes/kids/images/widget-91.png') }}"/>
                    </div>
                    <div class="desc">
                        <label>Footer</label>
                    </div>
                                                                                    ...
                                                                                    <table align="left" cellpadding="0" cellspacing="0" class="social_table" role="presentation" style="table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-tspace: 0; mso-table-rspace: 0; mso-table-bspace: 0; mso-table-lspace: 0;" valign="top">
                                                                                       <tbody>
                                                                                          <tr align="left" style="vertical-align: top; display: inline-block; text-align: left;" valign="top">
                                                                                             <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 4px; padding-left: 0px;" valign="top"><a builder-element="" href="https://www.facebook.com/" target="_blank"><img builder-element="" alt="Facebook" height="32" src="{{ url('assets/template/themes/kids/images/facebook2x.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;" title="facebook" width="32"></a></td>
                                                                                             <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 4px; padding-left: 0px;" valign="top"><a builder-element="" href="https://www.twitter.com/" target="_blank"><img builder-element="" alt="Twitter" height="32" src="{{ url('assets/template/themes/kids/images/twitter2x.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;" title="twitter" width="32"></a></td>
                                                                                             <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 4px; padding-left: 0px;" valign="top"><a builder-element="" href="https://www.linkedin.com/" target="_blank"><img builder-element="" alt="Linkedin" height="32" src="{{ url('assets/template/themes/kids/images/linkedin2x.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;" title="linkedin" width="32"></a></td>
                                                                                             <td style="word-break: break-word; vertical-align: top; padding-bottom: 0; padding-right: 4px; padding-left: 0px;" valign="top"><a builder-element="" href="https://www.instagram.com/" target="_blank"><img builder-element="" alt="Instagram" height="32" src="{{ url('assets/template/themes/kids/images/instagram2x.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; display: block;" title="instagram" width="32"></a></td>
                                                                                          </tr>
                                                                                       </tbody>
                                                                                    </table>
                                                                                 </td>
