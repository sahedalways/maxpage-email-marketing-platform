...
@include('helpers.form_control', ['required' => true, 'type' => 'text', 'label' => 'Template name', 'name' => 'name', 'value' => $template->name, 'rules' => ['name' => 'required']])
            ...
            setup: function (editor) {
                ...
                editor.ui.registry.addMenuButton('acelletags', {
                    ...
                    items.push({
                        ...
                        onAction: function (_) {
                            editor.insertContent('<a href="{UNSUBSCRIBE_URL}">Click here to unsubscribe</a>');
                        }
                    });
                    ...
                    items.push({
                        ...
                        text: 'WEB_VIEW_LINK',
                        onAction: function (_) {
                            editor.insertContent('<a href="{WEB_VIEW_URL}">Click to view web version of this email</a>');
                        }
                    });
