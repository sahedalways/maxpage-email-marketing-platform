<script>
        ...
        init() {
            ...
            this.setButtonHtml(`
                <div class="_1content widget-text">
                    <div class="panel__body woo-panel__body" title="Product">
                        <div class="image-drag">
                            <div ng-bind-html="::getModuleIcon(module)" class="ng-binding product-list-widget">
                                <img builder-element style="width:50px;opacity:0.5" src="{{ url('assets/template/images/rss_widget.svg') }}" width="100%" />
                            </div>
                        </div>
                ...
                <div builder-element="RssElement" data-url="" data-count="10">
                    <div class="container">
                        <div class="rss-placeholder">
                            <img src="{{ url('assets/template/images/images/rss-placeholder.svg') }}" width="100%" />
                            <button class="btn btn-secondary toggle shadown-sm" style="display:none">Preview</button>
                        </div>
                    </div>
                </div>
            `);
    ...
    class RssElement extends SuperElement  {
        ...
        preview() {
            ...
            element.obj.find('.btn').html('Close');
        }

        unpreview() {
            this.obj.attr('preview', 'off');
            this.obj.find('.btn').html('Preview');
        }
                ...
                <div id="RssControl">
                    <div class="control-[ID]">
                        <div class="widget-row px-3 py-2 d-flex align-items-center">
                            <div class="label mr-auto">URL</div>
