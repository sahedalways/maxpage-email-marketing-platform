<pagination class="d-flex align-items-center">
    <label class="small">
        Page {{$paginator->lastPage()}} of {{ $paginator->currentPage() }}
    </label>
    @if ($paginator->lastPage() > 1)
        <ul class="pagination justify-content-end small align-items-center mb-0 ms-4">
            <li class="page-item {{ $paginator->currentPage() == 1 ? 'disabled' : '' }}">
                <a class="page-link" href="{{ $paginator->url($paginator->currentPage()-1) }}" tabindex="-1" aria-disabled="true" data-page="{{ $paginator->currentPage()-1 }}"><i class="fas fa-arrow-left"></i></a>
            </li>
            ...
            <a class="page-link" href="{{ $paginator->url($paginator->currentPage()+1) }}" data-page="{{ $paginator->currentPage()+1 }}"><i class="fas fa-arrow-right"></i></a>
            </li>
        </ul>
    @endif
</pagination>
