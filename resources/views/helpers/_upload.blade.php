<div class="form-group control-text">
    <div class="sub_section">
        <h3 class="text-semibold text-primary">Profile Photo</h3>
        <div class="media profile-image d-flex">
            <div class="preview me-4 position-relative" id="{{$dragId}}">
                <a href="{{ $srcOrigin ?? $src }}" image-popup="link" class="upload-media-container radius-0 pre-upload-photo">
                    <img preview-for="image" empty-src="{{ asset('assets/template/images/placeholder.jpg') }}" src="{{ $src }}" class="rounded-circle" alt="">
                </a>
            ...
            <div class="col-md-10 padding-l0">
                ...
                <div class="mb-2">
                    <a href="#remove" class=" remove-profile-image"> Remove current photo</a>
                </div>
                <a href="#upload" onclick="$('input[name=image]').trigger('click')" class="btn btn-secondary">Upload photo</a>
            </div>
        </div>
    </div>
</div>
